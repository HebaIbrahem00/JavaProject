...
public class TicTacGUI { ///la dh wlaa 
    ...
    public TicTacGUI( String me, Stage stage,Scene se, Parent parent,Socket s) throws IOException {
        this.socket = s;
        ...
        buttons[0].setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (board.isValidMove(0, 0)) {
                    ...
                    System.out.println("before "+ Protocol.MAKE_MOVE);
                    out.println(Protocol.MAKE_MOVE);
                    System.out.println("after "+ Protocol.MAKE_MOVE);
